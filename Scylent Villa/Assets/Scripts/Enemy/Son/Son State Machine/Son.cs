...
public class Son : MonoBehaviour
{
    ...
    public SonFOV sonFOV { get; private set; }
    ...
    private void Awake()
    {
        ...
        IdleState = new SonIdleState(this, StateMachine);
        PatrolState = new SonPatrolState(this, StateMachine);
        ChaseState = new SonChaseState(this, StateMachine);
    }
